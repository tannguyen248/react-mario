...
export class App extends RComponent {
  constructor(props, context) {
    ...
    const jump = (keys, mario) => !keys[38] || mario.vy !== 0 ? mario : { ...mario, vy: 6.0 };
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return !ObjectUtil.equalDeep(nextState.mario, this.state.mario);
  }
